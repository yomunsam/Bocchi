...
public sealed partial class FluidStaticRenderer
{
    ...
    private static Dictionary<string, object?> MapContentItem(
        JsonElement item,
        SiteInfo site,
        FluidStaticTextResolver? text = null,
    ...
    private static void AddContentLocalizationModel(Dictionary<string, object?> model, JsonElement item, FluidStaticTextResolver text)
    {
    ...
    private static string GetLanguageDisplayName(FluidStaticTextResolver text, string language)
    {
    ...
    private static Dictionary<string, object?> CreateArticleTimeModel(JsonElement item, SiteInfo site, FluidStaticTextResolver text)
    {
