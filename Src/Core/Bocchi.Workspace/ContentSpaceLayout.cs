...
/// <summary>
/// 内容空间（Content Space）目录约定。对应 <c>Docs/Architecture.md §3</c> 与
/// <c>Docs/Milestones/M2/M2.md §3.2</c>。
/// </summary>
/// <remarks>
/// <para>
/// 内容空间是用户的纯创作资产；它必须满足"独立可携、可作为独立 Git 仓库、不含构建产物、
...
/// </list>
/// </remarks>
public sealed record ContentSpaceLayout
{
    /// <summary>构造一个内容空间布局。</summary>
    /// <param name="root">内容空间根目录的绝对路径。</param>
    public ContentSpaceLayout(string root)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(root);
        Root = Path.GetFullPath(root);
    }

    /// <summary>内容空间根目录。</summary>
    ...
    /// <summary>内容空间根 README（自动生成，说明本目录是源工程）。</summary>
    public string ReadmeFile => Path.Combine(Root, "README.md");

    /// <summary>内容空间根 .gitignore（自动生成）。</summary>
    public string GitIgnoreFile => Path.Combine(Root, ".gitignore");

    /// <summary>把绝对路径转换为相对内容空间根的、以 <c>/</c> 归一化的路径。</summary>
