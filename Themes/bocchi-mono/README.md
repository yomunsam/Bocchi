...
`bocchi-mono` is Bocchi's bundled default Theme. It uses the same Theme Contract as third-party Themes and does not define the Fluid Static implementation itself.
